...
<p align="left">
  ...
  <a href="https://shikhar-portfolio-phi.vercel.app/">
    <img src="https://img.shields.io/badge/Portfolio-000000?style=for-the-badge&logo=vercel&logoColor=white" alt="Portfolio" />
  </a>
  <a href="https://mail.google.com/mail/?view=cm&fs=1&to=shikharsrivastava3004@gmail.com">
...
**Autonomous regression testing platform for software repositories.**

TestPilot AI combines **AST analysis, dependency impact analysis, hybrid code retrieval, LangGraph agents, automated test generation, sandboxed execution, failure diagnosis, and PR automation** into an end-to-end testing workflow.

**Stack:** Python · FastAPI · LangGraph · Tree-sitter · Qdrant · PostgreSQL · Celery · Redis · Docker · Next.js

→ [View TestPilot AI](https://github.com/Shikhaar/TestPilot-AI)
